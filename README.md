...
```swift
dependencies: [
    .package(url: "https://github.com/Syzygy-Hub/syzygy-core-ios", from: "1.2.0")
]
```
...
|---|---|---|
| [syzygy-foundation-ios](https://github.com/Syzygy-Hub/syzygy-foundation-ios) | 1.2.0 | Foundation contracts, primitives, and shared types |
